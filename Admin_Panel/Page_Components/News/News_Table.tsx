      ...
      <Table className="border-none">
        <TableHeader>
          <TableRow className="text-blue-700">
            <TableHead className="font-bold  text-xl border-muted border-2 ">S.NO.</TableHead>
            ...
            <TableHead className="font-bold text-center text-xl border-muted border-2 p-0">
               <h1 className="font-bold text-center text-xl border-muted border-2">News Details</h1>
            <TableRow>
        ...
        {Array.from({ length: 5 }).map((_,index:number) => {
                return (
                  <TableRow key={index}>
                    ...
                    <TableCell className="text-center border-muted border-2">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Perspiciatis quod consequatur vero voluptatem excepturi debitis quidem minima totam illum tenetur, ut laudantium quia quibusdam dolores dignissimos dolorum at architecto! Illo quidem possimus dolorem nemo repudiandae ex dolore illum perferendis? Ad!</TableCell>
