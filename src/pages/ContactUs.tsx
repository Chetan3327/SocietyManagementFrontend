      ...
      <>
         ...
         <div className='h-full w-full flex items-center justify-center flex-col bg-white py-10 sm:py-20 px-4'>
             ...
             <div className='flex flex-col sm:flex-row mb-2'>
                ...
                className='bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-right '
                 type='email' id='email'
                 {...register('email')} placeholder='Enter your Email-id'
             ...
             <div className='flex flex-col sm:flex-row mb-2'>
                <label className='block text-gray-700 pt-2 font-bold md:text-left mb-1 sm:w-1/3 sm:pr-4' htmlFor='contact'>Contact No.</label>
                <input
                className='bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-right '
                 type='text' id='contact'
                 {...register('contact')} placeholder='Enter your Contact No.'
             ...
             <div className='flex flex-col sm:flex-row mb-2'>
                <label className='block text-gray-700 pt-2 font-bold md:text-left mb-1 sm:w-1/3 sm:pr-4' htmlFor='subject'>Batch</label>
             ...
             <div className='flex flex-col sm:flex-row mb-2'>
                <label className='block text-gray-700 pt-2 font-bold md:text-left mb-1 sm:w-1/3 sm:pr-4' htmlFor='subject'>Branch</label>
             ...
             <div className='flex flex-col sm:flex-row mb-2'>
                <label className='block text-gray-700 pt-2 font-bold md:text-left mb-1 sm:w-1/3 sm:pr-4' htmlFor='subject'>Enter your Society</label>
                {/* <input
                className='bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-right '
             ...
             <div className='flex flex-col sm:flex-row mb-2'>
                ...
                className='bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-right '
                 type='text' id='subject'
                 {...register('subject')} placeholder='Enter the Subject of your query'
                />
