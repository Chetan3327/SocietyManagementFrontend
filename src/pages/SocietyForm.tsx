                  ...
                  <div className="flex flex-col md:flex-row justify-between">
                    <div>
                      <div className="mb-2">
                        ...
                        <input
                          ...
                          className="lg:w-60 w-full border py-1 px-2 block rounded-lg"
                      ...
                      <div className="mb-2">
                        <label htmlFor="headname" className="mb-2 font-bold">
                          Full Name
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="mb-2">
                        <label htmlFor="branch" className="mb-2 font-bold">
                          Branch
                        </label>
                        <input
                          type="text"
                    ...
                    <div>
                      <div className="mb-2">
                        ...
                        <select
                          {...register("Category")}
                          className="w-full lg:w-60 border py-1 px-2 block rounded-lg"
                          defaultValue={" "}
                        >
                      ...
                      <div className="mb-2">
                        <label htmlFor="section" className="mb-2 font-bold">
                          Section
                        </label>
                        <input
                          type="text"
                    ...
                    <div>
                      <label htmlFor="about" className="mb-2 font-bold">
                        Describe your Society
                      </label>
                      <textarea
                        {...register("Describe")}
                        className="w-full lg:w-72 h-full border p-2 block rounded-lg"
