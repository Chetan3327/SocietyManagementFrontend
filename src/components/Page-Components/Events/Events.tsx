...
const cardEvents: EventCardType[] = [
  {
    ...
    venue: "Room 210",
    description:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum quam, id eum recusandae maxime eos commodi non repellendus, ullam necessitatibus porro aspernatur nostrum sunt et alias sint? Error, corrupti odit.",
...
const detailedEvents: EventCardDetailedType[] = [
  {
    img: [latest_new, latest_new],
    title: "Tech Talk : Future Of AI",
    subTitle: "Empowering the future ",
    description:
      "Join us for Codefest 2024 , a dynamic 3-day coding marathon designed to challenge your skills and foster innovation . This event is a fantastic oppurtunity for students of all levels to collaborate , learn and showcase their talent in software development",
    judgingCriteria: [
      ...
      <div className="relative w-full mx-auto">
        ...
        <div className="absolute inset-0 py-20 lg:py-28">
          ...
          <p className="text-white text-center text-xl font-extrabold ">
            ...
            and oppurtunities hosetd by socities .<br />A wide range of events
            are organised to inspire,educate and connect
          </p>
        </div>
      </div>
