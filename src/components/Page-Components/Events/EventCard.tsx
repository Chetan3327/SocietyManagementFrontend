...
const EventCardDetailed = ({ props }: { props: EventCardDetailedType }) => {
  return (
    <div className="w-full bg-gray-200 p-4 my-4">
      ...
      <h4 className="text-gray-700 text-center text-lg mb-4">
        {props.subTitle}
      </h4>
      ...
      <div className="flex flex-col lg:flex-row space-x-4 mb-4 ">
        ...
        <div>
          ...
          <div className="flex  w-full ">
            <span className=" text-3xl font-bold pb-4 mr-4  mt-4 ">
              Judging Criteria{" "}
            </span>{" "}
            <div className="mt-8 flex-grow border-t border-gray-900 hidden lg:block"></div>
          </div>
      ...
      <div className="flex flex-col lg:flex-row space-x-4 ">
        <div className="">
          <div className="flex  w-full ">
            <div className="mt-8 flex-grow border-t border-gray-900 hidden lg:block"></div>{" "}
            <span className=" text-3xl font-bold pb-4 ml-4 sm:mr-4 mt-4 ">
              Prizes{" "}
            </span>{" "}
            <div className="mt-8 flex-grow border-t border-gray-900 hidden lg:block"></div>
          </div>
